...
This file archives the NCat / NapCat / OneBot notes that were previously kept in the main README.

## Archived Scope

- Earlier local QQ access notes based on NCat / OneBot
- Historical mention of dual-backend positioning in the extension overview
- NCat-specific environment notes and acknowledgements
