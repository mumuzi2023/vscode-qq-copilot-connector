...
1. 前往 [QQ 机器人开放平台](https://q.qq.com/qqbot/openclaw/index.html) 注册 QQ 机器人。
2. 安装插件。
3. 在设置中填写 QQBot AppID 和 ClientSecret。
4. 连接 QQBot。
5. 通过侧边栏处理 QQ 会话，或在 VS Code Chat 中使用 `@qq`。
...
当前 README 使用上方预览图。更多截图可以在后续补充并替换。
